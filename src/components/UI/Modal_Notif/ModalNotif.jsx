        ...
        <div className={`card position-absolute border-1 ${Style["card-notif"]}`}>
          <div className="card-body ms-1">
                ...
                <div className='d-flex border-bottom mt-2'>
                    ...
                    <div className='ms-2'>
                        <div className='d-flex'>
                            <p className='m-0 fw-normal font-10 color-grey'>Penawaran Produk</p>
                            <p className={`mb-0 fw-normal font-10 color-grey ${Style["txt"]}`}>20 Apr, 14:04 <img src="/images/Ellipse 1.svg" alt=""/></p>
                        </div>
                ...
                <div className='d-flex border-bottom mt-2'>
                    ...
                    <div className='ms-2'>
                        <div className='d-flex'>
                            <p className='m-0 fw-normal font-10 color-grey'>Berhasil diterbitkan</p>
                            <p className={`mb-0 fw-normal font-10 color-grey ${Style["txt"]}`}>20 Apr, 14:04 <img src="/images/Ellipse 1.svg" alt=""/></p>
                        </div>
                        <p className='m-0 fw-normal'>Nama Produk</p>
