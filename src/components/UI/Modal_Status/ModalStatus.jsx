...
function ModalStatus() {
  ...
  return (
    <div>
        <div className={`card position-absolute border-1 ${Style["card-status"]}`}>
          <div className="card-body p-4">
              ...
              <h1 className="card-text mb-0 fs-6 mt-5">Perbarui status penjualan produkmu</h1>
              <div className='form-status mt-3'>
                <form action="">
                  <div className='form-check'>
                    <input type="radio" className={`form-check-input ${Style["input-status"]}`} name='radioButton' value="berhasil terjual" onChange={handleTextChange}/>
                  ...
                  <div className='form-check'>
                    <input type="radio" className={`form-check-input ${Style["input-status"]}`} name='radioButton' value="batalkan transaksi" onChange={handleTextChange}/>
