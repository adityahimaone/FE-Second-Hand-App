  ...
  return (
    <div className={`card position-absolute border-1 ${Style["card-style"]}`}>
        <div className="card-body p-4">
            ...
            <h1 className="card-text mb-0 mt-4 font-14 fw-semibold">Yeay kamu berhasil mendapatkan harga yang sesuai</h1>
            <h2 className="card-text mt-2 mb-0 font-14 color-gray">Segera hubungi pembeli melalui whatsapp untuk transaksi selanjutnya</h2>
            <div className={`card-body rounded-4 p-3 mt-3 ${Style["card-body"]}`}>
                ...
                <div className='item d-flex align-items-center'>
                    <img src="/images/people image.jpg" alt="" className={`rounded ${Style["item"]}`}/>
