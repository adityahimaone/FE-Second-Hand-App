...
function Modal() {
  return (
    <div className="card position-absolute border-1 card-style">
        <div className="card-body p-4">
            ...
            <div className='card-body rounded-4 p-3 mt-3'>
                <p className='text-center text'>Product Match</p>
                ...
                <div className='item d-flex align-items-center'>
                    ...
                    <div className='ms-2 align-content-center'>
                        <p className='m-0 text'>Nama Pembeli</p>
                ...
                <div className='item d-flex align-items-start mt-3'>
                    ...
                    <div className='ms-2 align-content-center'>
                        <p className='m-0 fw-normal text'>Nama Pembeli</p>
                        <p className='m-0 fw-normal text'><s>Rp. 250.000</s></p>
                        <p className='m-0 fw-normal text'>Ditawar Rp. 200.000</p>
                    </div>
                </div>
            </div>
            {/* Button */}
